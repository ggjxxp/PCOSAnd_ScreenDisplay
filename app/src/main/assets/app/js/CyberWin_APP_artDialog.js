...
#alert-layer{
	...
	*/
	...
	f.open = function(arg1,arg2,btnok,btncancel){
			lecture_index_now = 0;//第9999个功能
			keyboard模式 = "cyber_confirm";
			//alert(lecture_index_now);
			var content = "<div id='alert-layer'>"+
			"<div id='alert-container'>"+
				"<div id='alert-text-container'>"+
					"<p id='cyberwin_alert-title'>"+arg1+"——————未来之窗新思想</p>"+
					"<cyberdiv id='cyberwin_alert-detail'>"+arg2+"</cyberdiv>"+
				"</div>"+
				"<div id='alert-btn'>"+
						"<div id='cyberwin_alert-confirm' class='cyberwin_alert-btn_child cwpd-btn-block-info cl_handle_lecture_objc_1'>"+btnok+"</div>"+
						"<div id='cyberwin_alert-cancel' class='cyberwin_alert-btn_child cl_handle_lecture_objc_2'>"+btncancel+"</div>"+
				"</div>"+
			"</div>"+
		"</div>";
	...
	f.alert_confirm = function(){
		console.log("加载按钮");
			$("#cyberwin_alert-confirm").click(function(){
				lecture_index_now = 0 ;//还原 系统0 第9999个功能
	...
	f.layer = function(content,cyberwin_obj){
		//lecture_index_now = 9999;//第9999个功能
		lecture_index_now = 0;//第9999个功能
			keyboard模式 = "cyberdialog";
